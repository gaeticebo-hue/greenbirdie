...
.nav-cta:hover { background: #333; color: var(--white) !important; }
...
.hero {
  ...
  background: var(--dark);
  padding: 100px var(--section-h) 96px;
  position: relative;
  overflow: hidden;
}
...
.hero--page {
  padding: 80px var(--section-h) 72px;
}
...
.hero-inner { max-width: var(--max-w-text); }
...
@media (max-width: 480px) {
  h1 { font-size: 1.9rem; }
  h2 { font-size: 1.5rem; }
  .hero { padding: 60px var(--section-h) 52px; }
